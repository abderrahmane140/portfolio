export default function About() {
  return (
    <div
      className="flex flex-col md:flex-row justify-around md:items-start sm:pl-5 md:pl-5 pt-10 space-y-10 md:space-y-0 md:space-x-10 px-4 md:px-20 mt-20"
      id="about"
    >
      <div className="max-w-lg flex items-center lg:justify-between">
        <div className="mr-4">
          <img
            src="m.png"
            alt="Bsar Abduh"
            className="rounded-full w-32 md:w-40 lg:w-48 min-w-32"
          />
        </div>
        <div>
          <h1 className="text-4xl sm:text-4xl font-bold">Bsar Abderrahmane </h1>
