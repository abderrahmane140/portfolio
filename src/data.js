export const data =[
    ...
    {
        id:3,
        title:"Shopping Cart Simplifier",
...
export const experiences = [
  {
    ...
    date: "May 2025- Jun 2023",
    contents: [
      "Development of an educational course scraping application using Laravel.",
      "Structured data storage in MySQL with a dynamic filtering interface.",
      "Blade interface styled with Tailwind CSS."
    ],
  },
  {
    title: "Web Developer",
    ...
    contents: [
      "Design of a product and order management application for a B2B e-commerce website.",
      "Used Laravel Breeze for the backend, Blade + Tailwind CSS for the frontend.",
      "Implemented an admin authentication system and CRUD operations."
    ],
  },
  {
    title: "Web Developer",
    ...
    contents: [
      "Development of a car rental application using Laravel (backend) and React.js (frontend).",
      "Created secure RESTful APIs to manage users, vehicles, and reservations.",
      "Integrated an admin dashboard using React Query, Chart.js, and Tailwind CSS."
    ],
  },
];